...
class Movie
{
        ...
        $seven = new Movie ('Seven', 'David Fincher', 'The film tells the story of David Mills (Pitt), a detective who partners with the retiring William Somerset (Freeman) to track down a serial killer who uses the seven deadly sins as a motif in his murders. The screenplay was influenced by the time Walker spent in New York City trying to make it as a writer.', 1995, $img = './img/seven.jpg');
        // var_dump($seven);
